                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="lg:mt-12 lg:mb-5 w-full ">
                            <div className="flex flex-col justify-start items-center md:flex-row w-full md:w-1/2 lg:w-full m-auto">
                                ...
                                <a href="/signup" className="w-full mb-5 px-10 py-3 md:p-3 bg-yellow-200 text-white rounded-3xl hover:bg-yellow-400 hover:boroder-solid-white text-center md:w-1/2">
                                    立刻開始
                                </a>
                            </div>
                        </div>
